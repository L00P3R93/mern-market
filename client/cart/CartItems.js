...
export default function CartItems(props){
    ...
    const handleChange = index => event => {
        ...
        if(event.target.value == 0) updatedCartItems[index].quantity = 1
        else updatedCartItems[index] = event.target.value
    ...
    const removeItem = index => event => {
        ...
        if(updatedCartItems.length == 0) props.setCheckout(false)
        setCartItems(updatedCartItems)
    }
    ...
    return (
        <Card className={classes.card}>
            <Typography type="title" className={classes.title}>Shopping Cart</Typography>
            {cartItems.length>0 
                ? (<span>
                    {
                                ...
                                <span key={i}>
                                    <Card className={classes.cart}>
                                        ...
                                        <div className={classes.details}>
                                            ...
                                            <div className={classes.subheading}> Quantity: 
                                                <TextField
                                                    value={item.quantity}
                    ...
                    <div className={classes.checkout}>
                        ...
                        {!props.checkout && (auth.isAuthenticated()
                            ...
                            : <Link to="/signin"><Button color="primary" variant="contained">Sign in to checkout</Button></Link>)
                        }
