    ...
    return (
        <span>
            ...
            <Dialog open={open} onClose={handleRequestClose}>
                ...
                <DialogContent>
                    <DialogContentText>Confirm to delete your shop {props.shop.name}</DialogContentText>
                </DialogContent>
                <DialogActions>
                    <Button onClick={handleRequestClose} color='primary'>Cancel</Button>
                    <Button onClick={deleteShop} color='secondary' autoFocus='autoFocus'>Confirm</Button>
                </DialogActions>
            </Dialog>
        </span>
    )
