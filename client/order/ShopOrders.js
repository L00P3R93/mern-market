...
export default function ShopOrders({match}){
    ...
    useEffect(() => {
        ...
        listByShop({shopId: match.params.shopId}, {t: jwt.token}, signal)
            .then((data) => {
    ...
    const handleClick = index => event => { setOpen(index) }
    ...
    return (
        <div>
            <Paper className={classes.root} elevation={4}>
                <Typography type="title" className={classes.title}>Orders in {match.params.shop}</Typography>
                <List dense>
                            ...
                            <span key={index}>
                                ...
                                <Collapse component="li" in={open === index} timeout="auto" unmountOnExit>
                                    ...
                                    <div className={classes.customerDetails}>
                                        <Typography type="subheading" component="h3" className={classes.subheading}>Deliver to:</Typography>
